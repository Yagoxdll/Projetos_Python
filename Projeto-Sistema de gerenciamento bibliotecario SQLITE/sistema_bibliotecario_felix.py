...
class TelaInicial:
    ...
    def __init__(self, master):
        ...
        # Cores
        self.master.configure(background=cor_cinza)

        style = Style()
        style.theme_use("clam")

        # Frames
        self.frame_superior = Frame(self.master, bg=cor_cinza_claro)
        ...
        self.logo_app = Label(self.frame_superior, image=self.logo_photo, bg=cor_cinza_claro)
        ...
        self.explanation_text = Label(self.frame_inferior, text='''O sistema de gerenciamento para guardar\n informações de livros e seus empréstimos'''
                                      , font=("Times New Roman", 16))
        self.explanation_text.grid(row=0, column=0, padx=10)

        self.status_msg1 = Label(self.frame_status, text=f"LIVROS [{how_many_books()}]")
        self.status_msg1.grid(row=0, column=0, sticky="ew", padx=10, pady=5)

        self.status_msg2 = Label(self.frame_status, text=f"USUÁRIOS [{how_many_users()}]")
        self.status_msg2.grid(row=0, column=1, sticky="ew", padx=10, pady=5)

        self.status_msg3 = Label(self.frame_status, text=f"EMPRÉSTIMOS [{how_many_loans()}]")
    ...
    def atualizar_status(self):
        ...
        self.status_msg1.config(text=f"LIVROS [{how_many_books()}]")
        self.status_msg2.config(text=f"USUÁRIOS [{how_many_users()}]")
        self.status_msg3.config(text=f"EMPRÉSTIMOS [{how_many_loans()}]")
...
class NewUserWindow:
    ...
    def add_user(self):
        ...
        insert_user(self.nome_get, self.sobrenome_get, self.bairro_get,\
    ...
    def __init__(self, main_window):
        ...
        self.new_user_window.configure(background=cor_jumbo)
        ...
        #Botões
        self.botao_salvar = Button(self.frame_direito, width=20, text="Salvar",background=cor_jumbo, command=self.add_user)
        self.botao_sair = Button(self.frame_direito, width=20, text="Sair", background=cor_jumbo, command=self.sair_new_win)
...
class NewBookWindow:
    ...
    def add_book(self):
        ...
        # Insere dados nos bancos de dados
        insert_book(self.titulo_get, self.autor_get, self.editora_get,\
    ...
    def __init__(self, main_window):
        ...
        self.new_book_window.configure(background=cor_jumbo)
        ...
        #Botões
        self.botao_salvar = Button(self.frame_direito, width=20, text="Salvar",background=cor_jumbo, command=self.add_book)
        self.botao_sair = Button(self.frame_direito, width=20, text="Sair", background=cor_jumbo, command=self.sair_new_book)
...
class listUsersWindow:
    ...
    def __init__(self, main_window):
        ...
        self.new_list_user_window.configure(background=cor_jumbo)
...
class listBooksWindow:
    ...
    def __init__(self, main_window):
        ...
        self.new_list_all_books.configure(background=cor_jumbo)
...
class listbooksInLoan:
    ...
    def __init__(self, main_window):
        ...
        self.new_window_books_in_loan.configure(background=cor_jumbo)
...
class listCompletedReturns:
    ...
    def __init__(self, main_window):
        ...
        self.new_window_completed_returns.configure(background=cor_jumbo)
        ...
        self.dados = get_loans_with_return_date()
...
class insertLoan:
    ...
    def add_loan(self):
        ...
        self.test_usuario_existe = verify_user_exist(self.id_usuario_get)  # Corrigir o parâmetro
        if not self.test_usuario_existe:
            messagebox.showerror("Erro", "O usuário não está cadastrado")
            return

        # Verifica se o livro existe
        self.test_livro_existe = verify_book_exist(self.id_livro_get)
        ...
        self.test_disponivel = verify_available_book(self.id_livro_get)
        ...
        if self.test_disponivel == True:
            insert_loan(self.id_livro_get,  self.id_usuario_get, self.date_now, None)
    ...
    def __init__(self, main_window):
        ...
        self.new_window_insert_loan.configure(background=cor_jumbo)
        ...
        #Botões
        self.botao_salvar = Button(self.frame_direito, width=20, text="Salvar",background=cor_jumbo, command=self.add_loan)
        self.botao_sair = Button(self.frame_direito, width=20, text="Sair", background=cor_jumbo, command=self.sair_new_win)
...
class returnLoan:
    ...
    def return_book_in_loan(self):
        ...
        self.test_verifica_possivel = verify_loan_exist(self.data_id_emprestimo_get)
        ...
        self.test_verifica_emprestimo = verify_available_loan(self.data_id_emprestimo_get)
        ...
        # Insere dados nos bancos de dados
        return_loan(self.data_id_emprestimo_get, self.date_now)
    ...
    def __init__(self, main_window):
        ...
        self.new_window_return_loan.configure(background=cor_jumbo)
        ...
        # Botões
        self.botao_salvar = Button(self.frame_direito, width=20, text="Salvar",background=cor_jumbo, command=self.return_book_in_loan)
        self.botao_sair = Button(self.frame_direito, width=20, text="Sair", background=cor_jumbo, command=self.sair_new_win)
...
class deleteUser:
    ...
    def remove_user(self):
        ...
        # Insere dados nos bancos de dados
        self.delete_test = delete_user(self.data_id_usuario_get)
    ...
    def __init__(self, main_window):
        ...
        self.new_window_delete_user.configure(background=cor_jumbo)
        ...
        # Botões
        self.botao_confirmar = Button(self.frame_direito, width=20, text="Confirmar",background=cor_jumbo, command=self.remove_user)
        self.botao_sair = Button(self.frame_direito, width=20, text="Sair", background=cor_jumbo, command=self.sair_delete_user)
...
class deleteBook:
    ...
    def remove_book(self):
        ...
        # Insere dados nos bancos de dados
        self.delete_test = delete_book(self.data_id_book_get)
    ...
    def __init__(self, main_window):
        ...
        self.new_window_delete_book.configure(background=cor_jumbo)
        ...
        # Botões
        self.botao_salvar = Button(self.frame_direito, width=20, text="Salvar",background=cor_jumbo, command=self.remove_book)
        self.botao_sair = Button(self.frame_direito, width=20, text="Sair", background=cor_jumbo, command=self.sair_delete_book)
...
class sobreSistema:
    ...
    def __init__(self, main_window):
        ...
        self.new_window_about.configure(background=cor_cinza_claro)
